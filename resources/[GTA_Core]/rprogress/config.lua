...
Config.Color            = "rgba(143, 143, 143, 1.0)"    -- Progress bar colour
Config.BGColor          = "rgba(0, 0, 0, 0.7)"          -- Progress background colour

Config.x            = 0.2 + 0.01 -- Horizontal position
Config.y            = 0.8 + 0.07 -- Vertical position

Config.Rotation     = 260     -- Rotation angle of dial
Config.MaxAngle     = 360   -- Max arc in degrees - 360 will be a full circle, 90 will be a quarter of a circle, etc
Config.Radius       = 30    -- Radius of the dial
Config.Stroke       = 6   -- stroke width of the dial
